...
describe('RoutingService', () => {
  ...
  it('should get correct back route on user page when back route is undefined', inject([RoutingService], (service: RoutingService) => {
  ...
  it('should get correct back route on user page when back route is set to user', inject([RoutingService], (service: RoutingService) => {
  ...
  it('should get correct back route on login page', inject([RoutingService], (service: RoutingService) => {
    service.currentRoute = 'login';
    service.getBackRoute('', '', '');
    expect(service.backRoute).toEqual(['']);
  }));

  it('should get correct back route on room page', inject([RoutingService], (service: RoutingService) => {
    service.currentRoute = '';
    service.getBackRoute(UserRole.EXECUTIVE_MODERATOR, '', ':shortId');
    expect(service.backRoute).toEqual(['user']);
  }));

  it('should get correct back route on room comments page', inject([RoutingService], (service: RoutingService) => {
